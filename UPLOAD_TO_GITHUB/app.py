...
FLOW_CASE_DETAIL = {
    "prelim": {
        "1": {"A": {"code": "P1", "title": "Cardiogenic Shock (Fulminant Myocarditis)",
                    "patient": "Sita · 1 yr · 10 kg",
                    "pearl": "No fluid boluses (the ‘fluid trap’) — start Adrenaline, synchronized cardioversion 0.5 J/kg for VT with pulse"},
              "B": {"code": "B1", "title": "Near Drowning / Submersion with VT Arrest",
                    "patient": "Vaibhavi · 12 yr · 30 kg · Seawater submersion, hypothermia 35°C",
                    "pearl": "Defibrillate 2 J/kg FIRST, then CPR — not Adrenaline before the shock"}},
        "2": {"A": {"code": "P3", "title": "Acute Severe Asthma with Pneumothorax",
                    "patient": "Arun · 3 yr · 10 kg · Steroid-phobic family",
                    "pearl": "RSI with Ketamine + Rocuronium — recognize post-intubation right pneumothorax → needle decompression 2nd ICS MCL"},
              "B": {"code": "B4", "title": "Refractory Status Epilepticus with Respiratory Arrest",
                    "patient": "Sita · 12 yr · 30 kg · Raised ICP, unequal pupils",
                    "pearl": "Recognize raised ICP → 3% NaCl / Mannitol — RSI with Ketamine only"}},
        "3": {"A": {"code": "P2", "title": "Scorpion Sting Envenomation — Acute RV Strain and Diastolic Failure",
                    "patient": "Arjun · 10 yr · 30 kg · Red scorpion sting, cold shock",
                    "pearl": "Avoid large fluid bolus & Noradrenaline — give Prazosin + Dobutamine/Milrinone to unload the RV"},
              "B": {"code": "B3", "title": "Electrocution with VT Arrest",
                    "patient": "Arush · 13 yr · 30 kg · K⁺ 7.5, burns",
                    "pearl": "Calcium gluconate for K⁺ 7.5 — critical and often missed; defibrillate 2 J/kg first"}},
...
def _key_visible_to_judge(key, my_slot, deb_revealed):
    ...
    semi-final sheet entries, and debriefer entries stay secret until revealed.
    Organiser sessions are never filtered."""
...
def set_judge_identity():
    ...
    if slot not in ('cj1', 'cj2', 'cj3', 'crm1', 'crm2', 'pals', 'bls', 'debriefer', ''):
