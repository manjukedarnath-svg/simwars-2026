...
CASES = [
    ...
    },
    {
        ...
        "summary": "2-year-old child (8 kg) post-VSD repair (3 weeks ago) presents with fever, dullness, and breathing difficulty. Wound discharge, hypoglycemia (28 mg/dl), hyponatremia (Na 122). Parents stopped Flecainide and Propranolol. The team must recognize septic shock, give fluid boluses, start inotropes/antibiotics, correct glucose/Na, and avoid misdiagnosis.",
        "background": "2-year-old Manoj, weighing 8 kg, presents with breathing difficulty for a few hours and extreme dullness, progressively increasing over 2 days. Extremely poor oral intake in the last 24 hours. Recently discharged after open-heart surgery.",
        "expanded_history": "From remote village. Underwent VSD repair 3 weeks ago. Discharged after 10 days in ICU due to heart complications. Parents have strips of Flecainide and Propranolol which they have not been giving for last 2 days. Discharge summary confirms open VSD surgery with patch repair, post-op arrythmias.",
        "stages": [
            {"name": "Stage 1: Initial Assessment", "vitals": "HR: 180, RR: 50, BP: 70/30, SpO2: 77% (RA), ECG: Sinus tach", "condition": "Dull, drowsy. Sternotomy wound with discharge. Tachypnoeic. Glucose 28mg/dl.", "expected": "Recognize septic shock + hypoglycemia. Start high-flow O2. Apply monitors. Obtain IV access. Give Dextrose bolus (65ml 10%).", "notes": "Show discharge summary if asked. Parents produce strips of meds."},
            {"name": "Stage 2: Escalation (Fluid Refractory)", "vitals": "HR: 170, RR: 62, BP: 84/50, SpO2: 96% (NRM), ECG: Sinus tach", "condition": "Drowsy, moaning. Liver 2cm.", "expected": "Give 1st fluid bolus (20ml/kg) → reassess → Give 2nd fluid bolus (20ml/kg). Recognize fluid-refractory shock.", "notes": "If 2nd bolus given → proceed. If delayed → worsening."},
            {"name": "Stage 3: Critical Decision Point", "vitals": "HR: 170, BP: 84/50, SpO2: 96%, ECG: Sinus tach", "condition": "Labs: Na 122, K 3.3, Glucose 28, Lactate 7, CRP 200 (real).", "expected": "Branch A (Correct): Start Noradrenaline/Epinephrine → Give broad-spectrum antibiotics (Meropenem + Vancomycin) → Correct hyponatremia (3% NaCl) → Correct glucose → Prepare for intubation.\nBranch B (Incorrect): Misdiagnose as arrhythmia (treat with antiarrhythmics) OR delay antibiotics.", "notes": "If correct inotropes+Abx → 4A. If misdiagnosis (arrhythmia treatment) → 4B."},
            {"name": "Stage 4: Outcome", "vitals": "4A (Stable): HR 120, BP 85/50, Sinus rhythm. 4B (Arrest): Asystole.", "condition": "4A: Intubated, on inotropes. 4B: Asystole / Refractory shock.", "expected": "4A: Stabilize, shift to PICU. 4B: Start CPR.", "notes": "End scenario."}
        ],
        "patient": {"name": "Manoj", "mrn": "5530", "gender": "Male", "age": "2 years", "dob": "10-07-2022", "height": "85 cm", "weight": "8 kg", "cc": "Breathing difficulty, dullness, poor oral intake", "hpi": "Progressive breathing difficulty for 2 days. Poor oral intake 24 hours. Fever.", "pmh": "Open VSD repair with patch repair 3 weeks ago. Post-op arrythmias, prolonged ICU stay.", "psh": "VSD repair (3 weeks ago).", "meds": "Flecainide and Propranolol (stopped by parents for 2 days).", "allergies": "None.", "family": "Parents illiterate, from remote village, very anxious."},
        "actors": "Parents produce medicine strips when asked; cannot give detailed history. Nurse gives wrong CRP report (2 instead of 200) initially, then corrects.",
        "equipment": "Simulator (pediatric), ECG monitor, BVM, IV supplies, Inotropes (Noradrenaline/Epinephrine), Antibiotics, Dextrose, 3% NaCl, Airway kit, Crash cart."
    },
    {
        "id": "P3",
        "round": "ROUND TWO",
